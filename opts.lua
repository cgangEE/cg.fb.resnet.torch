...
function M.parse(arg)
   ...
   ------------- Training options --------------------
   cmd:option('-fold',            '1',     'fold to train')
   ...
   cmd:option('-LR',              0.006,   'initial learning rate')
   ...
   elseif opt.dataset == 'cifar100' then
       ...
       opt.shortcutType = opt.shortcutType == '' and 'A' or opt.shortcutType
       opt.nEpochs = opt.nEpochs == 0 and 164 or opt.nEpochs
   elseif opt.dataset == 'flickr' then
      opt.shortcutType = opt.shortcutType == '' and 'B' or opt.shortcutType
      opt.nEpochs = opt.nEpochs == 0 and 10 or opt.nEpochs
   elseif opt.dataset == 'nist' then
      opt.shortcutType = opt.shortcutType == '' and 'B' or opt.shortcutType
      opt.nEpochs = opt.nEpochs == 0 and 10 or opt.nEpochs
   elseif opt.dataset == 'nistFlickr' then
      opt.shortcutType = opt.shortcutType == '' and 'B' or opt.shortcutType
      opt.nEpochs = opt.nEpochs == 0 and 10 or opt.nEpochs
   elseif opt.dataset == 'flickrNist' then
      opt.shortcutType = opt.shortcutType == '' and 'B' or opt.shortcutType
      opt.nEpochs = opt.nEpochs == 0 and 10 or opt.nEpochs
   else
